...
FUZZ_TEST(test_cmdline_find_option, struct cmdline_find_option_arg)
{
	...
	KFUZZTEST_EXPECT_NOT_NULL(cmlind_find_option_arg, cmdline);
	KFUZZTEST_EXPECT_NOT_NULL(cmlind_find_option_arg, option);
	KFUZZTEST_ANNOTATE_STRING(cmdline_find_option_arg, cmdline);
	KFUZZTEST_ANNOTATE_STRING(cmdline_find_option_arg, option);
